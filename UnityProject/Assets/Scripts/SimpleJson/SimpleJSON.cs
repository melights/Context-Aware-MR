...
// from: http://wiki.unity3d.com/index.php/SimpleJSON#SimpleJSON.cs
// good tool to edit and check json online: http://www.jsoneditoronline.org/
...
namespace SimpleJSON
{
    ...
    public static class JSON
    {
        ...
        public static JSONNode ParseFile(string aJSONFilePath)
        {
            TextAsset data = Resources.Load(aJSONFilePath) as TextAsset;
